      ...
      <div class="logo-search">
        <div class="container">
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <a href="home" title="101FM">
                <img src="{base_url}assets/img/logo-101fm.png" class="img-responsive" alt="101FM">
              </a>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="pull-left">
        ...
        <div class="container">
          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              <li class="active">
                <a href="home" class="glyphicon glyphicon-home visible-xs visible-sm"> Home</a>
