        ...
        <div class="container">
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <a href="javascript:void(0);" title="101FM">
                <img src="{base_url}assets/img/logo-101fm.png" alt="101FM">
              </a>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="pull-left">
              <a href="javascript:void(0);" title="Rádio ao vivo">
                <img src="{base_url}assets/img/ao-vivo.png" alt="Rádio ao vivo">
              </a>
            </div>
    ...
    <div class="container corpo text-center">
      ...
      <div class="row fale-aqui">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <ul class="nav nav-tabs borderLessRadius">
            <li class="active">
              <a href="javascript:void(0);" data-toggle="tab">Fale Aqui</a>
            </li>
          </ul>
          <div class="retangulo-conteudo">
      ...
      <div class="row top10">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <ul class="nav nav-tabs borderLessRadius">
            <li class="active">
              <a href="javascript:void(0);" data-toggle="tab">TOP 10</a>
            </li>
          </ul>
      ...
      <div class="row fale-conosco">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <ul class="nav nav-tabs borderLessRadius">
            <li class="active">
              <a href="javascript:void(0);" data-toggle="tab">Fale Conosco</a>
            </li>
          </ul>
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="col-lg-2 col-lg-offset-3 col-md-2 col-md-offset-3 col-sm-2 col-sm-offset-3 col-xs-12 col-xs-offset-0">
                <a href="javascript:void(0);">
                  <div class="end-tel-mail circle">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              <div id="mapita" class="pull-right"></div>
            </div>
          </div>
          <div class="row text-center conteudo hidden-xs">
            <div class="col-lg-2">
              <h2>Endereço</h2>
              <address>R. Mário Guarita Cartaxo, N° 123 - Jd Paulista Cep: - 14875-325 - Jaboticabal - SP</address>
            </div>
        ...
        <script src="{base_url}assets/js/maps.google.js"></script>
